...
#define	SEEDKEY_LEN						16//PIN长度（Bytes）
#define	SEED_LEN					32//种子长度（Bytes）
#define MACKEY_LEN                     16 
#define KEY_LEN                     16
#define SN_LEN                      15
#define PW_SM_LEN                       16
#define TIME_LEN                    8   //时间因子长度  
#define AC_LEN              		12   //激活码长度
#define PW_LEN                      6
#define PWLOCK_LIMITED				6
#define SCREENLEN					8		//13
#define PAY_PARA_LEN                 40

#define BASE_2011MINUTES             21563520uL //即BASE_MINUTES_2011,stm8编译器用BASE_MINUTES_2011会溢出，故直接赋值
...
extern UINT8 idata gUserInfo[SEED_LEN];			//种子
...
extern UINT8 idata g_u1SN[16];              //序列号
